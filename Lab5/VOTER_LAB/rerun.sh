...
rm -rf /home/$USER/Lab5/DEV301-v5.2-Lab5/VOTER_LAB/OUT

ARGS=$1

hadoop jar Voter.jar Voter.VoterDriver $ARGS /home/$USER/Lab5/DEV301-v5.2-Lab5/VOTER_LAB/DATA/myvoter.csv /home/$USER/Lab5/DEV301-v5.2-Lab5/VOTER_LAB/OUT
