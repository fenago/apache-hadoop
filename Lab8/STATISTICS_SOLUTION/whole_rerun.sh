...
echo "Deleting OUT folder from hadoop filesystem (ignore not found warning)"
...
hadoop fs -copyToLocal  /home/$USER/Lab8/STATISTICS_SOLUTION/ /home/$USER/Lab8/STATISTICS_SOLUTION/output
